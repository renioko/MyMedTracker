...
# from utils import connect_to_database, DatabaseHandler
# from UI.menu import Menu, MedicineMenu, PatientMenu, PrescriptionMenu
# from models import Medicine, Patient, Prescription, Patient_Medicines_View
...
# class Patient_Medicines_ViewDB(DatabaseHandler):
#     '''This class manages database operations and Patient_Medicines_View logic'''
#     def __init__(self):
#         # Inicjalizujemy klasę bazową DatabaseHandler
#         super().__init__()

    # @classmethod  #//przeniesione z PatientDB
    # def get_patient_details_to_load(cls) -> tuple[str, str]:
    #     choice = input('You want to load patient data. Do you know patient id? Y/N')
    #     if choice.lower() == 'y':
    #         try:
